  ...
  return (
    <div>
      <div className="flex h-full items-center justify-center">
        <div
          className="relative h-full w-full max-w-screen-lg overflow-hidden"
          style={{
            maskImage: `
        ...
        >
          <div className="mx-auto grid h-full w-[300px] animate-skew-scroll grid-cols-1 gap-5 sm:w-[600px] sm:grid-cols-2">
            {items.map((item) => (
              <div
                key={item.id}
