  ...
  return (
    <div className="flex justify-between items-center flex-col xl:flex-row gap-8 xl:items-start">
      <div className="relative w-full max-w-[400px] flex flex-row justify-between items-start">
        ...
        {results.length > 0 && (
          <ul className="absolute w-[100%] max-h-[400px] overflow-y-auto bg-white border border-gray-300 rounded-md mt-10">
            {results.map((product) => (
              <li
                key={product._id}
      ...
      {cart.length > 0 && (
        <div
          id="cart"
          className="max-w-[720px] w-[100%] h-[400px] border p-6 rounded-md overflow-y-auto overflow-x-auto"
        >
